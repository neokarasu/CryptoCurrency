...
$burst_exitcost = (0.0025 * ($burst_exitamount * $cmc_burst_rate)) + (0.9 * $exchange_EUR_USD );
$cardano_exitcost = (0.0025 * ($cardano_exitamount * $cmc_cardano_rate)) + (0.9 * $exchange_EUR_USD );
$eos_exitcost = (0.0025 * ($eos_exitamount * $cmc_eos_rate)) + (0.9 * $exchange_EUR_USD );
$iota_exitcost = (0.0025 * ($iota_exitamount * $cmc_iota_rate)) + (0.9 * $exchange_EUR_USD );
$neo_exitcost = (0.0025 * ($neo_exitamount * $cmc_neo_rate)) + (0.9 * $exchange_EUR_USD );
$ripple_exitcost = (0.0025 * ($ripple_exitamount * $cmc_ripple_rate)) + (0.9 * $exchange_EUR_USD );
$verge_exitcost = (0.0025 * ($verge_exitamount * $cmc_verge_rate)) + (0.9 * $exchange_EUR_USD );
$waves_exitcost = (0.0025 * ($waves_exitamount * $cmc_waves_rate)) + (0.9 * $exchange_EUR_USD );
$zcash_exitcost = (0.0025 * ($zcash_exitamount * $cmc_zcash_rate)) + (0.9 * $exchange_EUR_USD );

$burst_totalexit = ($burst_exitamount * $cmc_burst_rate) - $burst_exitcost;
$cardano_totalexit = ($cardano_exitamount * $cmc_cardano_rate) - $cardano_exitcost;
$eos_totalexit = ($eos_exitamount * $cmc_eos_rate) - $eos_exitcost;
$iota_totalexit = ($iota_exitamount * $cmc_iota_rate) - $iota_exitcost;
$neo_totalexit = ($neo_exitamount * $cmc_neo_rate) - $neo_exitcost;
$ripple_totalexit = ($ripple_exitamount * $cmc_ripple_rate) - $ripple_exitcost;
$verge_totalexit = ($verge_exitamount * $cmc_verge_rate) - $verge_exitcost;
$waves_totalexit = ($waves_exitamount * $cmc_waves_rate) - $waves_exitcost;
$zcash_totalexit = ($zcash_exitamount * $cmc_zcash_rate) - $zcash_exitcost;
