...
$paper_total_profit = $paper_btc_profit + $paper_eth_profit + $paper_ltc_profit;
$paper_total_percent_profit = ($paper_total_profit / ($paper_btc_totalbuyin + $paper_eth_totalbuyin + $paper_ltc_totalbuyin)) * 100;
$paper_total_exitprofit = $paper_btc_exitprofit + $paper_eth_exitprofit + $paper_ltc_exitprofit;
$paper_total_percent_exitprofit = ($paper_total_exitprofit / ($paper_btc_totalbuyin + $paper_eth_totalbuyin + $paper_ltc_totalbuyin)) * 100;
